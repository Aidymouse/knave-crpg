...
function Draw_Engine.load_map(map)
    ...
    for _, layer in ipairs(map.layers) do
        for tile_index_plus_one, tile_gid in ipairs(layer.data) do
            ...
            local cell_tile = Draw_Engine.tiles[tile_gid]
            ...
            table.insert(Draw_Engine.cells, new_cell)
...
function Draw_Engine.draw_world()
    ...
    if u_Debug.debug_mode then
        u_Debug.tile_red = 1
        tile_red_step = 1 / #Draw_Engine.cells
    end
...
function Draw_Engine.update(dt)
    ...
    if not u_Debug.pause_water_bobbing then
        ...
        for i, entity in ipairs(o_Game_State.world_entities) do
            ...
            if Draw_Engine.tiles[cell.tile_gid].type == "water" then
