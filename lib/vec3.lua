...
vec3 = {
  ...
  __eq = function (v, u) return v.x == u.x and v.y == u.y and v.z == u.z end,
...
quat = {
  ...
  __index = {
    ...
    getAngleAxis = function(q)
      if q.w > 1 or q.w < -1 then q:normalizealize() end
